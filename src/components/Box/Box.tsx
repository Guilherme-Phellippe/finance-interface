...
export function Box({ title, value, isNegative, width }: Box) {
    return (
        <div
            ...
            className={twMerge("group border p-4 relative rounded-md my-4 shadow-[0_2px_10px_#000] data-[negative=true]:border-red-800 border-green-900 data-[negative=true]:bg-red-800/30 bg-green-950/30", width)}
        >
            <span
